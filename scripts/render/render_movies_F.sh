...
python render_movies.py --stype=mass-oneshot-example-F --inference --counterbalance F mass-oneshot-example-F~kappa-1.0 mass-oneshot-example-F~kappa--1.0
python render_movies.py --stype=mass-oneshot-F --inference --counterbalance --feedback F mass-oneshot-F~kappa-1.0 mass-oneshot-F~kappa--1.0
