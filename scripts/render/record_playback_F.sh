...
python record_playback.py --stype=mass-oneshot-example-F mass-oneshot-example-F~kappa-1.0
python record_playback.py --stype=mass-oneshot-F mass-oneshot-F~kappa-1.0
