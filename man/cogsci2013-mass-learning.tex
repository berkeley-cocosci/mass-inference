...
\begin{figure*}[t]
  \begin{center}
    ...
    \includegraphics[width=0.89\textwidth]{../figures/model.png}
...
\begin{figure*}[t]
  \begin{center}
    \includegraphics[width=\textwidth]{../figures/explicit_mass_judgments.pdf}
...
\begin{figure*}[t]
  \centering
  % \begin{tabular}[t]{cc}
      \subfloat{\includegraphics[width=0.4\textwidth]{../figures/model_performance_E.pdf}}%
      \subfloat{\includegraphics[width=0.4\textwidth]{../figures/model_performance_C.pdf}}
% \\
% \small
